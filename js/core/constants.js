...
export const THEME_PRESETS = {
  ...
  cosmic: { bg:'#2a1535', card:'#351840', pink:'#c9a84c', pink2:'#e8c96a', soft:'#4a2060', line:'#6b3d8a', text:'#f0e6d3', muted:'#b89cc8', inputBg:'#2a1535', inputText:'#f0e6d3', tableBg:'#2a1535', shadow:'0 10px 40px rgba(0,0,0,.55)' },
};
